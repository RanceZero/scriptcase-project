  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tipos_agendamento" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tipos_agendamento_form();
	}
...
?>
  ...
  // ---------- Validate descr_tipo_agendamento_
  function do_ajax_form_tipos_agendamento_validate_descr_tipo_agendamento_(iNumLinha)
  {
    var nomeCampo_descr_tipo_agendamento_ = "descr_tipo_agendamento_" + iNumLinha;
    var var_descr_tipo_agendamento_ = scAjaxGetFieldText(nomeCampo_descr_tipo_agendamento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agendamento_validate_descr_tipo_agendamento_(var_descr_tipo_agendamento_, iNumLinha, var_script_case_init, do_ajax_form_tipos_agendamento_validate_descr_tipo_agendamento__cb);
  } // do_ajax_form_tipos_agendamento_validate_descr_tipo_agendamento_

  function do_ajax_form_tipos_agendamento_validate_descr_tipo_agendamento__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "descr_tipo_agendamento_" + iLineNumber;
    }
    else
    {
      sFieldValid = "descr_tipo_agendamento_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "descr_tipo_agendamento_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "descr_tipo_agendamento_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agendamento_validate_descr_tipo_agendamento__cb

  // ---------- Validate duracao_exibida_tipo_agendamento_
  function do_ajax_form_tipos_agendamento_validate_duracao_exibida_tipo_agendamento_(iNumLinha)
  {
    var nomeCampo_duracao_exibida_tipo_agendamento_ = "duracao_exibida_tipo_agendamento_" + iNumLinha;
    var var_duracao_exibida_tipo_agendamento_ = scAjaxGetFieldText(nomeCampo_duracao_exibida_tipo_agendamento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agendamento_validate_duracao_exibida_tipo_agendamento_(var_duracao_exibida_tipo_agendamento_, iNumLinha, var_script_case_init, do_ajax_form_tipos_agendamento_validate_duracao_exibida_tipo_agendamento__cb);
  } // do_ajax_form_tipos_agendamento_validate_duracao_exibida_tipo_agendamento_

  function do_ajax_form_tipos_agendamento_validate_duracao_exibida_tipo_agendamento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "duracao_exibida_tipo_agendamento_" + iLineNumber;
    }
    else
    {
      sFieldValid = "duracao_exibida_tipo_agendamento_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "duracao_exibida_tipo_agendamento_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "duracao_exibida_tipo_agendamento_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agendamento_validate_duracao_exibida_tipo_agendamento__cb

  // ---------- Validate tipo_duracao_tipo_agendamento_
  function do_ajax_form_tipos_agendamento_validate_tipo_duracao_tipo_agendamento_(iNumLinha)
  {
    var nomeCampo_tipo_duracao_tipo_agendamento_ = "tipo_duracao_tipo_agendamento_" + iNumLinha;
    var var_tipo_duracao_tipo_agendamento_ = scAjaxGetFieldText(nomeCampo_tipo_duracao_tipo_agendamento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agendamento_validate_tipo_duracao_tipo_agendamento_(var_tipo_duracao_tipo_agendamento_, iNumLinha, var_script_case_init, do_ajax_form_tipos_agendamento_validate_tipo_duracao_tipo_agendamento__cb);
  } // do_ajax_form_tipos_agendamento_validate_tipo_duracao_tipo_agendamento_

  function do_ajax_form_tipos_agendamento_validate_tipo_duracao_tipo_agendamento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tipo_duracao_tipo_agendamento_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tipo_duracao_tipo_agendamento_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tipo_duracao_tipo_agendamento_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tipo_duracao_tipo_agendamento_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agendamento_validate_tipo_duracao_tipo_agendamento__cb

  // ---------- Validate duracao_tipo_agendamento_
  function do_ajax_form_tipos_agendamento_validate_duracao_tipo_agendamento_(iNumLinha)
  {
    var nomeCampo_duracao_tipo_agendamento_ = "duracao_tipo_agendamento_" + iNumLinha;
    var var_duracao_tipo_agendamento_ = scAjaxGetFieldText(nomeCampo_duracao_tipo_agendamento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agendamento_validate_duracao_tipo_agendamento_(var_duracao_tipo_agendamento_, iNumLinha, var_script_case_init, do_ajax_form_tipos_agendamento_validate_duracao_tipo_agendamento__cb);
  } // do_ajax_form_tipos_agendamento_validate_duracao_tipo_agendamento_

  function do_ajax_form_tipos_agendamento_validate_duracao_tipo_agendamento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "duracao_tipo_agendamento_" + iLineNumber;
    }
    else
    {
      sFieldValid = "duracao_tipo_agendamento_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "duracao_tipo_agendamento_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "duracao_tipo_agendamento_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agendamento_validate_duracao_tipo_agendamento__cb

  // ---------- Validate valor_tipo_agendamento_
  function do_ajax_form_tipos_agendamento_validate_valor_tipo_agendamento_(iNumLinha)
  {
    var nomeCampo_valor_tipo_agendamento_ = "valor_tipo_agendamento_" + iNumLinha;
    var var_valor_tipo_agendamento_ = scAjaxGetFieldText(nomeCampo_valor_tipo_agendamento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agendamento_validate_valor_tipo_agendamento_(var_valor_tipo_agendamento_, iNumLinha, var_script_case_init, do_ajax_form_tipos_agendamento_validate_valor_tipo_agendamento__cb);
  } // do_ajax_form_tipos_agendamento_validate_valor_tipo_agendamento_

  function do_ajax_form_tipos_agendamento_validate_valor_tipo_agendamento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "valor_tipo_agendamento_" + iLineNumber;
    }
    else
    {
      sFieldValid = "valor_tipo_agendamento_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "valor_tipo_agendamento_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "valor_tipo_agendamento_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agendamento_validate_valor_tipo_agendamento__cb

  // ---------- Validate ativado_tipo_agendamento_
  function do_ajax_form_tipos_agendamento_validate_ativado_tipo_agendamento_(iNumLinha)
  {
    var nomeCampo_ativado_tipo_agendamento_ = "ativado_tipo_agendamento_" + iNumLinha;
    var var_ativado_tipo_agendamento_ = scAjaxGetFieldRadio(nomeCampo_ativado_tipo_agendamento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agendamento_validate_ativado_tipo_agendamento_(var_ativado_tipo_agendamento_, iNumLinha, var_script_case_init, do_ajax_form_tipos_agendamento_validate_ativado_tipo_agendamento__cb);
  } // do_ajax_form_tipos_agendamento_validate_ativado_tipo_agendamento_

  function do_ajax_form_tipos_agendamento_validate_ativado_tipo_agendamento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ativado_tipo_agendamento_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ativado_tipo_agendamento_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ativado_tipo_agendamento_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ativado_tipo_agendamento_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agendamento_validate_ativado_tipo_agendamento__cb

  // ---------- Validate id_tipo_agendamento_
  function do_ajax_form_tipos_agendamento_validate_id_tipo_agendamento_(iNumLinha)
  {
    var nomeCampo_id_tipo_agendamento_ = "id_tipo_agendamento_" + iNumLinha;
    var var_id_tipo_agendamento_ = scAjaxGetFieldHidden(nomeCampo_id_tipo_agendamento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agendamento_validate_id_tipo_agendamento_(var_id_tipo_agendamento_, iNumLinha, var_script_case_init, do_ajax_form_tipos_agendamento_validate_id_tipo_agendamento__cb);
  } // do_ajax_form_tipos_agendamento_validate_id_tipo_agendamento_

  function do_ajax_form_tipos_agendamento_validate_id_tipo_agendamento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "id_tipo_agendamento_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_tipo_agendamento_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "id_tipo_agendamento_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_tipo_agendamento_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_agendamento_validate_id_tipo_agendamento__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tipos_agendamento_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tipos_agendamento_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tipos_agendamento_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tipos_agendamento_add_new_line_cb);
  } // do_ajax_form_tipos_agendamento_add_new_line

  function do_ajax_form_tipos_agendamento_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tipos_agendamento_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tipos_agendamento_backup_line(iNumLinha)
  {
    var var_id_tipo_agendamento_ = scAjaxGetFieldHidden("id_tipo_agendamento_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_agendamento_backup_line(var_id_tipo_agendamento_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tipos_agendamento_backup_line_cb);
  } // do_ajax_form_tipos_agendamento_backup_line

  function do_ajax_form_tipos_agendamento_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tipos_agendamento_backup_line_cb

  function do_ajax_form_tipos_agendamento_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tipos_agendamento_cancel_insert

  function do_ajax_form_tipos_agendamento_cancel_update(iSeqVert)
  {
    do_ajax_form_tipos_agendamento_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tipos_agendamento_cancel_update

  function do_ajax_form_tipos_agendamento_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tipos_agendamento_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tipos_agendamento_table_refresh()
  {
    var var_id_tipo_agendamento_ = document.F2.id_tipo_agendamento_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tipos_agendamento_table_refresh(var_id_tipo_agendamento_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipos_agendamento_table_refresh_cb);
  } //  do_ajax_form_tipos_agendamento_table_refresh

  function do_ajax_form_tipos_agendamento_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_tipo_agendamento_.value = scAjaxGetKeyValue("id_tipo_agendamento_");
    ...
    scAjaxAlert(do_ajax_form_tipos_agendamento_table_refresh_cb_after_alert);
  } // do_ajax_form_tipos_agendamento_table_refresh_cb
  function do_ajax_form_tipos_agendamento_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tipos_agendamento_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tipos_agendamento_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tipos_agendamento_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_descr_tipo_agendamento_ = scAjaxGetFieldText("descr_tipo_agendamento_" + iNumLinha);
    var var_duracao_exibida_tipo_agendamento_ = scAjaxGetFieldText("duracao_exibida_tipo_agendamento_" + iNumLinha);
    var var_tipo_duracao_tipo_agendamento_ = scAjaxGetFieldText("tipo_duracao_tipo_agendamento_" + iNumLinha);
    var var_duracao_tipo_agendamento_ = scAjaxGetFieldText("duracao_tipo_agendamento_" + iNumLinha);
    var var_valor_tipo_agendamento_ = scAjaxGetFieldText("valor_tipo_agendamento_" + iNumLinha);
    var var_ativado_tipo_agendamento_ = scAjaxGetFieldRadio("ativado_tipo_agendamento_" + iNumLinha);
    var var_id_tipo_agendamento_ = scAjaxGetFieldHidden("id_tipo_agendamento_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tipos_agendamento_submit_form(var_descr_tipo_agendamento_, var_duracao_exibida_tipo_agendamento_, var_tipo_duracao_tipo_agendamento_, var_duracao_tipo_agendamento_, var_valor_tipo_agendamento_, var_ativado_tipo_agendamento_, var_id_tipo_agendamento_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tipos_agendamento_submit_form_cb);
  } // do_ajax_form_tipos_agendamento_submit_form

  function do_ajax_form_tipos_agendamento_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("descr_tipo_agendamento_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("duracao_exibida_tipo_agendamento_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tipo_duracao_tipo_agendamento_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("duracao_tipo_agendamento_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("valor_tipo_agendamento_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ativado_tipo_agendamento_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("id_tipo_agendamento_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tipos_agendamento_submit_form_cb_after_alert);
  } // do_ajax_form_tipos_agendamento_submit_form_cb
  function do_ajax_form_tipos_agendamento_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tipos_agendamento_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tipos_agendamento_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tipos_agendamento_navigate_form, function() {});
    } else {
      perform_ajax_form_tipos_agendamento_navigate_form();
    }
  }

  function perform_ajax_form_tipos_agendamento_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tipos_agendamento_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("descr_tipo_agendamento_" + iNavForm);
      scAjaxHideErrorDisplay("duracao_exibida_tipo_agendamento_" + iNavForm);
      scAjaxHideErrorDisplay("tipo_duracao_tipo_agendamento_" + iNavForm);
      scAjaxHideErrorDisplay("duracao_tipo_agendamento_" + iNavForm);
      scAjaxHideErrorDisplay("valor_tipo_agendamento_" + iNavForm);
      scAjaxHideErrorDisplay("ativado_tipo_agendamento_" + iNavForm);
      scAjaxHideErrorDisplay("id_tipo_agendamento_" + iNavForm);
    }
    var var_id_tipo_agendamento_ = document.F2.id_tipo_agendamento_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tipos_agendamento_navigate_form(var_id_tipo_agendamento_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipos_agendamento_navigate_form_cb);
  } // do_ajax_form_tipos_agendamento_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipos_agendamento']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tipos_agendamento_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_tipo_agendamento_.value = scAjaxGetKeyValue("id_tipo_agendamento_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tipos_agendamento_navigate_form_cb_after_alert);
  } // do_ajax_form_tipos_agendamento_navigate_form_cb
  function do_ajax_form_tipos_agendamento_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tipos_agendamento_navigate_form_cb_after_alert
  function sc_hide_form_tipos_agendamento_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "descr_tipo_agendamento_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "duracao_exibida_tipo_agendamento_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tipo_duracao_tipo_agendamento_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "duracao_tipo_agendamento_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "valor_tipo_agendamento_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ativado_tipo_agendamento_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_tipo_agendamento_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["descr_tipo_agendamento_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tipos_agendamento_fld_descr_tipo_agendamento'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["duracao_exibida_tipo_agendamento_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tipos_agendamento_fld_duracao_exibida_tipo_agendamento'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tipo_duracao_tipo_agendamento_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tipos_agendamento_fld_tipo_duracao_tipo_agendamento'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["duracao_tipo_agendamento_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tipos_agendamento_fld_duracao_tipo_agendamento'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["valor_tipo_agendamento_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tipos_agendamento_fld_valor_tipo_agendamento'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["ativado_tipo_agendamento_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tipos_agendamento_fld_ativado_tipo_agendamento'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["id_tipo_agendamento_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tipos_agendamento_fld_id_tipo_agendamento'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["descr_tipo_agendamento_"][iNumLinha] = "descr_tipo_agendamento_" + iNumLinha;
    ajax_field_mult["duracao_exibida_tipo_agendamento_"][iNumLinha] = "duracao_exibida_tipo_agendamento_" + iNumLinha;
    ajax_field_mult["tipo_duracao_tipo_agendamento_"][iNumLinha] = "tipo_duracao_tipo_agendamento_" + iNumLinha;
    ajax_field_mult["duracao_tipo_agendamento_"][iNumLinha] = "duracao_tipo_agendamento_" + iNumLinha;
    ajax_field_mult["valor_tipo_agendamento_"][iNumLinha] = "valor_tipo_agendamento_" + iNumLinha;
    ajax_field_mult["ativado_tipo_agendamento_"][iNumLinha] = "ativado_tipo_agendamento_" + iNumLinha;
    ajax_field_mult["id_tipo_agendamento_"][iNumLinha] = "id_tipo_agendamento_" + iNumLinha;
    ajax_field_id["descr_tipo_agendamento_" + iNumLinha] = new Array("hidden_field_label_descr_tipo_agendamento_", "hidden_field_data_descr_tipo_agendamento_" + iNumLinha);
    ajax_field_id["duracao_exibida_tipo_agendamento_" + iNumLinha] = new Array("hidden_field_label_duracao_exibida_tipo_agendamento_", "hidden_field_data_duracao_exibida_tipo_agendamento_" + iNumLinha);
    ajax_field_id["tipo_duracao_tipo_agendamento_" + iNumLinha] = new Array("hidden_field_label_tipo_duracao_tipo_agendamento_", "hidden_field_data_tipo_duracao_tipo_agendamento_" + iNumLinha);
    ajax_field_id["duracao_tipo_agendamento_" + iNumLinha] = new Array("hidden_field_label_duracao_tipo_agendamento_", "hidden_field_data_duracao_tipo_agendamento_" + iNumLinha);
    ajax_field_id["valor_tipo_agendamento_" + iNumLinha] = new Array("hidden_field_label_valor_tipo_agendamento_", "hidden_field_data_valor_tipo_agendamento_" + iNumLinha);
    ajax_field_id["ativado_tipo_agendamento_" + iNumLinha] = new Array("hidden_field_label_ativado_tipo_agendamento_", "hidden_field_data_ativado_tipo_agendamento_" + iNumLinha);
    ajax_error_count["descr_tipo_agendamento_" + iNumLinha] = "off";
    ajax_error_count["duracao_exibida_tipo_agendamento_" + iNumLinha] = "off";
    ajax_error_count["tipo_duracao_tipo_agendamento_" + iNumLinha] = "off";
    ajax_error_count["duracao_tipo_agendamento_" + iNumLinha] = "off";
    ajax_error_count["valor_tipo_agendamento_" + iNumLinha] = "off";
    ajax_error_count["ativado_tipo_agendamento_" + iNumLinha] = "off";
    ajax_error_count["id_tipo_agendamento_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["descr_tipo_agendamento_" + iNumLinha] = "off";
    ajax_read_only["duracao_exibida_tipo_agendamento_" + iNumLinha] = "off";
    ajax_read_only["tipo_duracao_tipo_agendamento_" + iNumLinha] = "off";
    ajax_read_only["duracao_tipo_agendamento_" + iNumLinha] = "off";
    ajax_read_only["valor_tipo_agendamento_" + iNumLinha] = "off";
    ajax_read_only["ativado_tipo_agendamento_" + iNumLinha] = "off";
    ajax_read_only["id_tipo_agendamento_" + iNumLinha] = "on";
<?php
}
else
{
?>
    ajax_read_only["descr_tipo_agendamento_" + iNumLinha] = "on";
    ajax_read_only["duracao_exibida_tipo_agendamento_" + iNumLinha] = "on";
    ajax_read_only["tipo_duracao_tipo_agendamento_" + iNumLinha] = "on";
    ajax_read_only["duracao_tipo_agendamento_" + iNumLinha] = "on";
    ajax_read_only["valor_tipo_agendamento_" + iNumLinha] = "on";
    ajax_read_only["ativado_tipo_agendamento_" + iNumLinha] = "on";
    ajax_read_only["id_tipo_agendamento_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["descr_tipo_agendamento_" + iNumLinha] = null;
    ajax_error_list["duracao_exibida_tipo_agendamento_" + iNumLinha] = null;
    ajax_error_list["tipo_duracao_tipo_agendamento_" + iNumLinha] = null;
    ajax_error_list["duracao_tipo_agendamento_" + iNumLinha] = null;
    ajax_error_list["valor_tipo_agendamento_" + iNumLinha] = null;
    ajax_error_list["ativado_tipo_agendamento_" + iNumLinha] = null;
    ajax_error_list["id_tipo_agendamento_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "descr_tipo_agendamento_": new Array(),
    "duracao_exibida_tipo_agendamento_": new Array(),
    "tipo_duracao_tipo_agendamento_": new Array(),
    "duracao_tipo_agendamento_": new Array(),
    "valor_tipo_agendamento_": new Array(),
    "ativado_tipo_agendamento_": new Array(),
    "id_tipo_agendamento_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["descr_tipo_agendamento_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["descr_tipo_agendamento_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["descr_tipo_agendamento_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["descr_tipo_agendamento_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["descr_tipo_agendamento_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["duracao_exibida_tipo_agendamento_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["duracao_exibida_tipo_agendamento_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["duracao_exibida_tipo_agendamento_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["duracao_exibida_tipo_agendamento_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["duracao_exibida_tipo_agendamento_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tipo_duracao_tipo_agendamento_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tipo_duracao_tipo_agendamento_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tipo_duracao_tipo_agendamento_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tipo_duracao_tipo_agendamento_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tipo_duracao_tipo_agendamento_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["duracao_tipo_agendamento_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["duracao_tipo_agendamento_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["duracao_tipo_agendamento_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["duracao_tipo_agendamento_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["duracao_tipo_agendamento_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["valor_tipo_agendamento_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["valor_tipo_agendamento_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["valor_tipo_agendamento_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["valor_tipo_agendamento_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["valor_tipo_agendamento_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["ativado_tipo_agendamento_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ativado_tipo_agendamento_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ativado_tipo_agendamento_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ativado_tipo_agendamento_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ativado_tipo_agendamento_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["id_tipo_agendamento_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_tipo_agendamento_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_tipo_agendamento_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_tipo_agendamento_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_tipo_agendamento_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['descr_tipo_agendamento_'])) ? $this->nmgp_cmp_readonly['descr_tipo_agendamento_'] : 'off';
?>
    scAjaxFieldRead("descr_tipo_agendamento_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['duracao_exibida_tipo_agendamento_'])) ? $this->nmgp_cmp_readonly['duracao_exibida_tipo_agendamento_'] : 'off';
?>
    scAjaxFieldRead("duracao_exibida_tipo_agendamento_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tipo_duracao_tipo_agendamento_'])) ? $this->nmgp_cmp_readonly['tipo_duracao_tipo_agendamento_'] : 'off';
?>
    scAjaxFieldRead("tipo_duracao_tipo_agendamento_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['duracao_tipo_agendamento_'])) ? $this->nmgp_cmp_readonly['duracao_tipo_agendamento_'] : 'off';
?>
    scAjaxFieldRead("duracao_tipo_agendamento_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['valor_tipo_agendamento_'])) ? $this->nmgp_cmp_readonly['valor_tipo_agendamento_'] : 'off';
?>
    scAjaxFieldRead("valor_tipo_agendamento_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ativado_tipo_agendamento_'])) ? $this->nmgp_cmp_readonly['ativado_tipo_agendamento_'] : 'off';
?>
    scAjaxFieldRead("ativado_tipo_agendamento_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_tipo_agendamento_'])) ? $this->nmgp_cmp_readonly['id_tipo_agendamento_'] : 'on';
?>
    scAjaxFieldRead("id_tipo_agendamento_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("descr_tipo_agendamento_" + iSeq, "on");
    scAjaxFieldRead("duracao_exibida_tipo_agendamento_" + iSeq, "on");
    scAjaxFieldRead("tipo_duracao_tipo_agendamento_" + iSeq, "on");
    scAjaxFieldRead("duracao_tipo_agendamento_" + iSeq, "on");
    scAjaxFieldRead("valor_tipo_agendamento_" + iSeq, "on");
    scAjaxFieldRead("ativado_tipo_agendamento_" + iSeq, "on");
    scAjaxFieldRead("id_tipo_agendamento_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["descr_tipo_agendamento_" + iRow] || "on" == ajax_error_count["duracao_exibida_tipo_agendamento_" + iRow] || "on" == ajax_error_count["tipo_duracao_tipo_agendamento_" + iRow] || "on" == ajax_error_count["duracao_tipo_agendamento_" + iRow] || "on" == ajax_error_count["valor_tipo_agendamento_" + iRow] || "on" == ajax_error_count["ativado_tipo_agendamento_" + iRow] || "on" == ajax_error_count["id_tipo_agendamento_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_descr_tipo_agendamento_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_duracao_exibida_tipo_agendamento_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tipo_duracao_tipo_agendamento_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_duracao_tipo_agendamento_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_valor_tipo_agendamento_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ativado_tipo_agendamento_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_tipo_agendamento_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["descr_tipo_agendamento_" + iRow] && "off" == ajax_error_count["duracao_exibida_tipo_agendamento_" + iRow] && "off" == ajax_error_count["tipo_duracao_tipo_agendamento_" + iRow] && "off" == ajax_error_count["duracao_tipo_agendamento_" + iRow] && "off" == ajax_error_count["valor_tipo_agendamento_" + iRow] && "off" == ajax_error_count["ativado_tipo_agendamento_" + iRow] && "off" == ajax_error_count["id_tipo_agendamento_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["descr_tipo_agendamento_" + iRow] = "off";
        ajax_error_count["duracao_exibida_tipo_agendamento_" + iRow] = "off";
        ajax_error_count["tipo_duracao_tipo_agendamento_" + iRow] = "off";
        ajax_error_count["duracao_tipo_agendamento_" + iRow] = "off";
        ajax_error_count["valor_tipo_agendamento_" + iRow] = "off";
        ajax_error_count["ativado_tipo_agendamento_" + iRow] = "off";
        ajax_error_count["id_tipo_agendamento_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_descr_tipo_agendamento_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_duracao_exibida_tipo_agendamento_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tipo_duracao_tipo_agendamento_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_duracao_tipo_agendamento_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_valor_tipo_agendamento_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ativado_tipo_agendamento_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_id_tipo_agendamento_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("descr_tipo_agendamento_" == sIndex)
    {
    ...
    if ("duracao_exibida_tipo_agendamento_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("tipo_duracao_tipo_agendamento_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("duracao_tipo_agendamento_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("valor_tipo_agendamento_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("ativado_tipo_agendamento_" == sIndex)
    {
    ...
    if ("id_tipo_agendamento_" == sIndex)
    {

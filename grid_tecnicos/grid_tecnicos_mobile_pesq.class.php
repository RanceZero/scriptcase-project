...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id_tecnico";$Nm_numeric[] = "id_tecnico";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_fone_tecnico_cond" name="fone_tecnico_cond" onChange="nm_campos_between(document.getElementById('id_vis_fone_tecnico'), this, 'fone_tecnico')">
      ...
      <br><span id="id_hide_fone_tecnico"  <?php echo $str_hide_fone_tecnico?>><?php
      if ($fone_tecnico != "")
      {
      $fone_tecnico_look = substr($this->Db->qstr($fone_tecnico), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_nome_tecnico_cond" name="nome_tecnico_cond" onChange="nm_campos_between(document.getElementById('id_vis_nome_tecnico'), this, 'nome_tecnico')">
      ...
      <br><span id="id_hide_nome_tecnico"  <?php echo $str_hide_nome_tecnico?>><?php
      if ($nome_tecnico != "")
      {
      $nome_tecnico_look = substr($this->Db->qstr($nome_tecnico), 1, -1); 
      $nmgp_def_dados = array(); 

...
//
   ...
   { 
       ...
       $this->fone_tecnico = $Busca_temp['fone_tecnico']; 
       $tmp_pos = strpos($this->fone_tecnico, "##@@");
       if ($tmp_pos !== false && !is_array($this->fone_tecnico))
       {
           $this->fone_tecnico = substr($this->fone_tecnico, 0, $tmp_pos);
       }
       $this->id_tecnico = $Busca_temp['id_tecnico']; 
       $tmp_pos = strpos($this->id_tecnico, "##@@");
       if ($tmp_pos !== false && !is_array($this->id_tecnico))
       {
           $this->id_tecnico = substr($this->id_tecnico, 0, $tmp_pos);
       }
       $this->nome_tecnico = $Busca_temp['nome_tecnico']; 
       $tmp_pos = strpos($this->nome_tecnico, "##@@");
       if ($tmp_pos !== false && !is_array($this->nome_tecnico))
       {
           $this->nome_tecnico = substr($this->nome_tecnico, 0, $tmp_pos);
       }
       $this->email_tecnico = $Busca_temp['email_tecnico']; 
       $tmp_pos = strpos($this->email_tecnico, "##@@");
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_tecnicos_jquery-3.6.0.min.js\"></script>\r\n");
...
// 
 function label_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_usuario_login_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_usuario_login_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_usuario_login_label'] . "\" >&nbsp;</TD>\r\n");
   } 
 ...
 function NM_label_nome_tecnico()
 {
   ...
   if (!isset($this->NM_cmp_hidden['nome_tecnico']) || $this->NM_cmp_hidden['nome_tecnico'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_nome_tecnico_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_nome_tecnico_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $fieldSortRule = $this->scGetColumnOrderRule('nome_tecnico');
        $fieldSortIcon = $this->scGetColumnOrderIcon('nome_tecnico', $fieldSortRule);
        if (empty($this->Ini->Label_sort_pos) || $this->Ini->Label_sort_pos == 'right') {
            $this->Ini->Label_sort_pos = 'right_field';
        }
        if (empty($fieldSortIcon)) {
        ...
        $label_labelContent = "<a href=\"javascript:nm_gp_submit2('nome_tecnico')\" class=\"" . $this->css_scGridLabelLink . "\">". $label_labelContent . "</a>";
        $label_divLabel = "<div style=\"flex-grow: 1\">". $label_labelContent . "</div>";
        // controls
        $label_chart = '';
        $label_fixedColumn = '';
 ...
 function NM_label_email_tecnico()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_email_tecnico_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_email_tecnico_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
 ...
 function NM_label_fone_tecnico()
 {
   ...
   if (!isset($this->NM_cmp_hidden['fone_tecnico']) || $this->NM_cmp_hidden['fone_tecnico'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_fone_tecnico_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_fone_tecnico_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $fieldSortRule = $this->scGetColumnOrderRule('fone_tecnico');
        $fieldSortIcon = $this->scGetColumnOrderIcon('fone_tecnico', $fieldSortRule);
        if (empty($this->Ini->Label_sort_pos) || $this->Ini->Label_sort_pos == 'right') {
            $this->Ini->Label_sort_pos = 'right_field';
        }
        if (empty($fieldSortIcon)) {
        ...
        $label_labelContent = "<a href=\"javascript:nm_gp_submit2('fone_tecnico')\" class=\"" . $this->css_scGridLabelLink . "\">". $label_labelContent . "</a>";
        $label_divLabel = "<div style=\"flex-grow: 1\">". $label_labelContent . "</div>";
        // controls
        $label_chart = '';
        $label_fixedColumn = '';
 ...
 function NM_label_usuario_login()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_usuario_login_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_usuario_login_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
...
// 
   ...
   {  
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['SC_Ind_Groupby'] != "sc_free_total")
         {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['opc_psq'])
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['embutida_grid']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->Css_Cmp['css_usuario_login_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\">&nbsp;</TD>\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_usuario_login_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\">\r\n");
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['mostra_edit'] != "N"){ 
              ...
              {
                  $Parms_Edt  = "id_tecnico?#?" . str_replace('"', "@aspasd@", $this->id_tecnico) . "?@?NM_btn_insert?#?S?@?NM_btn_update?#?S?@?NM_btn_delete?#?S?@?NM_btn_navega?#?N?@?nmgp_opcao?#?igual?@?";
              ...
              {
                  $Md5_Edt  = "id_tecnico?#?" . str_replace('"', "@aspasd@", $this->id_tecnico) . "?@?NM_btn_insert?#?S?@?NM_btn_update?#?S?@?NM_btn_delete?#?S?@?NM_btn_navega?#?N?@?nmgp_opcao?#?igual?@?";
              }
              ...
              $Parms_Det  = "nmgp_chave_det?#?" . $this->id_tecnico . "?@?Sc_seq_det?#?" . $this->SC_seq_register . "?#?";
              $Md5_Det    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_tecnicos@SC_par@" . md5($Parms_Det);
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Lig_Md5'][md5($Parms_Det)] = $Parms_Det;
              ...
              if ($_SESSION['scriptcase']['proc_mobile']) {
                  $Link_Det  = nmButtonOutput($this->arr_buttons, "bcons_detalhes", "nm_submit_modal('" . $this->Ini->path_link . "grid_tecnicos/index.php?nmgp_parms=" . $Md5_Det . "&nmgp_parm_acum=&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&SC_lig_apl_orig=grid_tecnicos&nmgp_opcao=detalhe&KeepThis=true&TB_iframe=true&height=440&width=630&modal=true', '" . $Sc_parent . "')", "nm_submit_modal('" . $this->Ini->path_link . "grid_tecnicos/index.php?nmgp_parms=" . $Md5_Det . "&nmgp_parm_acum=&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&SC_lig_apl_orig=grid_tecnicos&nmgp_opcao=detalhe&KeepThis=true&TB_iframe=true&height=440&width=630&modal=true', '" . $Sc_parent . "')", "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              }
 ...
 function NM_grid_nome_tecnico()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['nome_tecnico']) || $this->NM_cmp_hidden['nome_tecnico'] != "off") { 
          $conteudo = sc_strip_script($this->nome_tecnico); 
          $conteudo_original = sc_strip_script($this->nome_tecnico); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'nome_tecnico', $str_tem_display, $conteudo_original); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'nome_tecnico', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_nome_tecnico_grid_line . "\"  style=\"" . $this->Css_Cmp['css_nome_tecnico_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_nome_tecnico_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_email_tecnico()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_email_tecnico_grid_line . "\"  style=\"" . $this->Css_Cmp['css_email_tecnico_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_email_tecnico_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_fone_tecnico()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['fone_tecnico']) || $this->NM_cmp_hidden['fone_tecnico'] != "off") { 
          $conteudo = sc_strip_script($this->fone_tecnico); 
          $conteudo_original = sc_strip_script($this->fone_tecnico); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'fone_tecnico', $str_tem_display, $conteudo_original); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'fone_tecnico', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['opcao'] != 'pdf') {
 ...
 function NM_grid_usuario_login()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_usuario_login_grid_line . "\"  style=\"" . $this->Css_Cmp['css_usuario_login_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_usuario_login_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function quebra_geral_sc_free_total_bot() 
 {
            ...
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
                        ...
                        if ($cmp == "fone_tecnico")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "fone_tecnico";
                           $lin_obj = $this->grid_search_fone_tecnico($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
                        if ($cmp == "id_tecnico")
                        {
                        ...
                        if ($cmp == "nome_tecnico")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "nome_tecnico";
                           $lin_obj = $this->grid_search_nome_tecnico($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('fone_tecnico','id_tecnico','nome_tecnico','email_tecnico');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq']) < 4)
       {
   ...
   function grid_search_fone_tecnico($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_fone_tecnico_" . $ind . "' style='display:none; z-index: 10'>";
       ...
       $lin_obj .= "       <select id='grid_search_fone_tecnico_cond_" . $ind . "' name='cond_grid_search_fone_tecnico_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle;' onChange='grid_search_hide_input(\"fone_tecnico\", $ind)'>";
       ...
       $lin_obj .= "       <span id=\"grid_fone_tecnico_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $fone_tecnico = $val_cmp;
       if ($fone_tecnico != "")
       {
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       ...
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_fone_tecnico_val_" . $ind . "' name='val_grid_search_fone_tecnico_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=20 alt=\"{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\" style='display: none'>";
       $tmp_pos = strpos($val_cmp, "##@@");
       if ($tmp_pos !== false) {
           $val_cmp = substr($val_cmp, ($tmp_pos + 4));
           $sAutocompValue = substr($sAutocompValue, ($tmp_pos + 4));
       }
       $lin_obj .= "     <input class='sc-js-input " . $this->css_scAppDivToolbarInput . "' type='text' id='id_ac_grid_fone_tecnico" . $ind . "' name='val_grid_search_fone_tecnico_autocomp" . $ind . "' size='20' value='" . NM_encode_input($sAutocompValue) . "' alt=\"{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\">";
       $lin_obj .= "       </span>";
       $lin_obj .= "          </div>";
   ...
   function grid_search_nome_tecnico($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_nome_tecnico_" . $ind . "' style='display:none; z-index: 10'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_nome_tecnico_cond_" . $ind . "' name='cond_grid_search_nome_tecnico_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle;' onChange='grid_search_hide_input(\"nome_tecnico\", $ind)'>";
       $selected = ($opc == "qp") ? " selected" : "";
       $lin_obj .= "        <option value='qp'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_like'] . "</option>";
       $selected = ($opc == "np") ? " selected" : "";
       $lin_obj .= "        <option value='np'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_not_like'] . "</option>";
       ...
       $lin_obj .= "       <span id=\"grid_nome_tecnico_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $nome_tecnico = $val_cmp;
       if ($nome_tecnico != "")
       {
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       ...
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_nome_tecnico_val_" . $ind . "' name='val_grid_search_nome_tecnico_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=50 alt=\"{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\" style='display: none'>";
       $tmp_pos = strpos($val_cmp, "##@@");
       if ($tmp_pos !== false) {
           $val_cmp = substr($val_cmp, ($tmp_pos + 4));
           $sAutocompValue = substr($sAutocompValue, ($tmp_pos + 4));
       }
       $lin_obj .= "     <input class='sc-js-input " . $this->css_scAppDivToolbarInput . "' type='text' id='id_ac_grid_nome_tecnico" . $ind . "' name='val_grid_search_nome_tecnico_autocomp" . $ind . "' size='50' value='" . NM_encode_input($sAutocompValue) . "' alt=\"{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\">";
       $lin_obj .= "       </span>";
       $lin_obj .= "          </div>";
       $lin_obj .= "          <div class='scGridFilterTagListFilterBar'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bapply_appdiv", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search')}, 200);", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search')}, 200);", "grid_search_apply_" . $ind . "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida("             {\r\n");
       $nm_saida->saida("                 tmp = Tab_obj_grid_search[i];\r\n");
       $nm_saida->saida("                 if (tmp == 'fone_tecnico')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                      var x_fone_tecnico = i;\r\n");
       $nm_saida->saida("                      $(\"#id_ac_grid_fone_tecnico\" + i).autocomplete({\r\n");
       ...
       $nm_saida->saida("                             field: \"fone_tecnico\",\r\n");
       ...
       $nm_saida->saida("                          $(\"#grid_search_fone_tecnico_val_\" + x_fone_tecnico).val(ui.item.value);\r\n");
       ...
       $nm_saida->saida("                             $(\"#grid_search_fone_tecnico_val_\" + x_fone_tecnico).val( $(this).val() );\r\n");
       $nm_saida->saida("                          }\r\n");
       $nm_saida->saida("                        }\r\n");
       $nm_saida->saida("                      });\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (tmp == 'nome_tecnico')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                      var x_nome_tecnico = i;\r\n");
       $nm_saida->saida("                      $(\"#id_ac_grid_nome_tecnico\" + i).autocomplete({\r\n");
       $nm_saida->saida("                        minLength: 1,\r\n");
       $nm_saida->saida("                        source: function (request, response) {\r\n");
       $nm_saida->saida("                        $.ajax({\r\n");
       $nm_saida->saida("                          url: \"index.php\",\r\n");
       ...
       $nm_saida->saida("                             nmgp_opcao: \"ajax_aut_comp_dyn_search\",\r\n");
       $nm_saida->saida("                             origem: \"grid\",\r\n");
       $nm_saida->saida("                             field: \"nome_tecnico\",\r\n");
       $nm_saida->saida("                             max_itens: \"10\",\r\n");
       $nm_saida->saida("                             cod_desc: \"N\",\r\n");
       $nm_saida->saida("                             script_case_init: " . $this->Ini->sc_page . "\r\n");
       $nm_saida->saida("                           },\r\n");
       ...
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        select: function (event, ui) {\r\n");
       $nm_saida->saida("                          $(\"#grid_search_nome_tecnico_val_\" + x_nome_tecnico).val(ui.item.value);\r\n");
       $nm_saida->saida("                          $(this).val(ui.item.label);\r\n");
       $nm_saida->saida("                          event.preventDefault();\r\n");
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        focus: function (event, ui) {\r\n");
       ...
       $nm_saida->saida("                        change: function (event, ui) {\r\n");
       $nm_saida->saida("                          if (null == ui.item) {\r\n");
       $nm_saida->saida("                             $(\"#grid_search_nome_tecnico_val_\" + x_nome_tecnico).val( $(this).val() );\r\n");
       $nm_saida->saida("                          }\r\n");
       $nm_saida->saida("                        }\r\n");
       $nm_saida->saida("                      });\r\n");
       $nm_saida->saida("                 }\r\n");
       ...
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'fone_tecnico')\r\n");
       $nm_saida->saida("                 {\r\n");
       ...
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'nome_tecnico')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     obj_ac  = 'id_ac_grid_' + Tab_obj_grid_search[i] + i;\r\n");
       $nm_saida->saida("                     result  = grid_search_get_text(obj_dyn + i, obj_ac);\r\n");
       $nm_saida->saida("                 }\r\n");

...
//-- ajax metodos ---
      ...
      if ($this->NM_ajax_opcao == 'autocomp_fone_tecnico')
      {
          $fone_tecnico = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_fone_tecnico($fone_tecnico);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nome_tecnico')
      {
          $nome_tecnico = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nome_tecnico($nome_tecnico);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_fone_tecnico($fone_tecnico)
   {
      $fone_tecnico = substr($this->Db->qstr($fone_tecnico), 1, -1);
            $fone_tecnico_look = substr($this->Db->qstr($fone_tecnico), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct fone_tecnico from " . $this->Ini->nm_tabela . " where  fone_tecnico like '%" . $fone_tecnico . "%' order by fone_tecnico"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_nome_tecnico($nome_tecnico)
   {
      $nome_tecnico = substr($this->Db->qstr($nome_tecnico), 1, -1);
            $nome_tecnico_look = substr($this->Db->qstr($nome_tecnico), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nome_tecnico from " . $this->Ini->nm_tabela . " where  nome_tecnico like '%" . $nome_tecnico . "%' order by nome_tecnico"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
   ...
   function lookup_ajax_email_tecnico($email_tecnico)
   {
      $email_tecnico = substr($this->Db->qstr($email_tecnico), 1, -1);
            $email_tecnico_look = substr($this->Db->qstr($email_tecnico), 1, -1); 
      $nmgp_def_dados = array(); 
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> tecnicos</TITLE>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_fone_tecnico_cond#NMF#' + search_get_sel_txt('SC_fone_tecnico_cond') + '@NMF@';
  str_out += 'SC_fone_tecnico#NMF#' + search_get_text('SC_fone_tecnico') + '@NMF@';
  str_out += 'id_ac_fone_tecnico#NMF#' + search_get_text('id_ac_fone_tecnico') + '@NMF@';
  ...
  str_out += 'SC_nome_tecnico_cond#NMF#' + search_get_sel_txt('SC_nome_tecnico_cond') + '@NMF@';
  str_out += 'SC_nome_tecnico#NMF#' + search_get_text('SC_nome_tecnico') + '@NMF@';
  str_out += 'id_ac_nome_tecnico#NMF#' + search_get_text('id_ac_nome_tecnico') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_nome_tecnico").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_nome_tecnico").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_nome_tecnico",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_nome_tecnico").val(ui.item.value);
   ...
   scClass = $("#id_ac_fone_tecnico").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_fone_tecnico").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_fone_tecnico",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_fone_tecnico").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $fone_tecnico_cond, $fone_tecnico, $fone_tecnico_autocomp,
             $id_tecnico_cond, $id_tecnico,
             $nome_tecnico_cond, $nome_tecnico, $nome_tecnico_autocomp,
      ...
      { 
          ...
          $fone_tecnico = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca']['fone_tecnico']; 
          $fone_tecnico_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca']['fone_tecnico_cond']; 
          ...
          $nome_tecnico = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca']['nome_tecnico']; 
          $nome_tecnico_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca']['nome_tecnico_cond']; 
      ...
      if (!isset($fone_tecnico_cond) || empty($fone_tecnico_cond))
      {
         $fone_tecnico_cond = "qp";
      }
      if (!isset($id_tecnico_cond) || empty($id_tecnico_cond))
      {
         $id_tecnico_cond = "gt";
      }
      if (!isset($nome_tecnico_cond) || empty($nome_tecnico_cond))
      {
         $nome_tecnico_cond = "qp";
      }
      ...
      $str_hide_fone_tecnico = (in_array($fone_tecnico_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id_tecnico = (in_array($id_tecnico_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nome_tecnico = (in_array($nome_tecnico_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_email_tecnico = (in_array($email_tecnico_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($fone_tecnico) || $fone_tecnico == "")
      {
          $fone_tecnico = "";
      }
      if (isset($fone_tecnico) && !empty($fone_tecnico))
      {
         $tmp_pos = strpos($fone_tecnico, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $fone_tecnico = substr($fone_tecnico, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($nome_tecnico) || $nome_tecnico == "")
      {
          $nome_tecnico = "";
      }
      if (isset($nome_tecnico) && !empty($nome_tecnico))
      {
         $tmp_pos = strpos($nome_tecnico, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $nome_tecnico = substr($nome_tecnico, 0, $tmp_pos);
         }
      }
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_fone_tecnico_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['fone_tecnico'])) ? $this->New_label['fone_tecnico'] : "" . $this->Ini->Nm_lang['lang_tecnicos_fld_fone_tecnico'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_fone_tecnico_cond" name="fone_tecnico_cond" onChange="nm_campos_between(document.getElementById('id_vis_fone_tecnico'), this, 'fone_tecnico')">
       <OPTION value="qp" <?php if ("qp" == $fone_tecnico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $fone_tecnico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $fone_tecnico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $fone_tecnico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fone_tecnico" <?php echo $str_hide_fone_tecnico?> valign="top">
...
<?php
      ...
      $fone_tecnico_look = substr($this->Db->qstr($fone_tecnico), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct fone_tecnico from " . $this->Ini->nm_tabela . " where fone_tecnico = '$fone_tecnico_look' order by fone_tecnico"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
      ...
      if (isset($nmgp_def_dados[0][$fone_tecnico]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$fone_tecnico];
      }
      else
      {
          $sAutocompValue = $fone_tecnico;
      }
?>
<INPUT  type="text" id="SC_fone_tecnico" name="fone_tecnico" value="<?php echo NM_encode_input($fone_tecnico) ?>"  size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_fone_tecnico" name="fone_tecnico_autocomp" size="20"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_id_tecnico_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['id_tecnico'])) ? $this->New_label['id_tecnico'] : "" . $this->Ini->Nm_lang['lang_tecnicos_fld_id_tecnico'] . ""; ?></TD>
...
?>
<INPUT  type="text" id="SC_id_tecnico" name="id_tecnico" value="<?php echo NM_encode_input($id_tecnico) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_nome_tecnico_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['nome_tecnico'])) ? $this->New_label['nome_tecnico'] : "" . $this->Ini->Nm_lang['lang_tecnicos_fld_nome_tecnico'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_nome_tecnico_cond" name="nome_tecnico_cond" onChange="nm_campos_between(document.getElementById('id_vis_nome_tecnico'), this, 'nome_tecnico')">
       <OPTION value="qp" <?php if ("qp" == $nome_tecnico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $nome_tecnico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nome_tecnico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $nome_tecnico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nome_tecnico" <?php echo $str_hide_nome_tecnico?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<?php
      ...
      $nome_tecnico_look = substr($this->Db->qstr($nome_tecnico), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nome_tecnico from " . $this->Ini->nm_tabela . " where nome_tecnico = '$nome_tecnico_look' order by nome_tecnico"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
      ...
      if (isset($nmgp_def_dados[0][$nome_tecnico]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$nome_tecnico];
      }
      else
      {
          $sAutocompValue = $nome_tecnico;
      }
?>
<INPUT  type="text" id="SC_nome_tecnico" name="nome_tecnico" value="<?php echo NM_encode_input($nome_tecnico) ?>"  size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_nome_tecnico" name="nome_tecnico_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_email_tecnico_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['email_tecnico'])) ? $this->New_label['email_tecnico'] : "" . $this->Ini->Nm_lang['lang_tecnicos_fld_email_tecnico'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.fone_tecnico_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_fone_tecnico'), document.F1.fone_tecnico_cond, 'fone_tecnico');
   document.F1.fone_tecnico.value = "";
   document.F1.fone_tecnico_autocomp.value = "";
   ...
   document.F1.nome_tecnico_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_nome_tecnico'), document.F1.nome_tecnico_cond, 'nome_tecnico');
   document.F1.nome_tecnico.value = "";
   document.F1.nome_tecnico_autocomp.value = "";
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "Projeto/grid_tecnicos";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_fone_tecnico_cond'] = 'cond';
      $tp_fields['SC_fone_tecnico'] = 'text_aut';
      $tp_fields['id_ac_fone_tecnico'] = 'text_aut';
      $tp_fields['SC_id_tecnico_cond'] = 'cond';
      $tp_fields['SC_id_tecnico'] = 'text';
      $tp_fields['SC_nome_tecnico_cond'] = 'cond';
      $tp_fields['SC_nome_tecnico'] = 'text_aut';
      $tp_fields['id_ac_nome_tecnico'] = 'text_aut';
   ...
   {
      global $fone_tecnico_cond, $fone_tecnico, $fone_tecnico_autocomp,
             $id_tecnico_cond, $id_tecnico,
             $nome_tecnico_cond, $nome_tecnico, $nome_tecnico_autocomp,
      ...
      if (!empty($fone_tecnico_autocomp) && empty($fone_tecnico))
      {
          $fone_tecnico = $fone_tecnico_autocomp;
      }
      if (!empty($nome_tecnico_autocomp) && empty($nome_tecnico))
      {
          $nome_tecnico = $nome_tecnico_autocomp;
      }
      if (!empty($email_tecnico_autocomp) && empty($email_tecnico))
      {
          $email_tecnico = $email_tecnico_autocomp;
      }
      $fone_tecnico_cond_salva = $fone_tecnico_cond; 
      if (!isset($fone_tecnico_input_2) || $fone_tecnico_input_2 == "")
      {
          $fone_tecnico_input_2 = $fone_tecnico;
      }
      ...
      $nome_tecnico_cond_salva = $nome_tecnico_cond; 
      if (!isset($nome_tecnico_input_2) || $nome_tecnico_input_2 == "")
      {
          $nome_tecnico_input_2 = $nome_tecnico;
      }
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca']['fone_tecnico'] = $fone_tecnico; 
      if (is_array($fone_tecnico) && !empty($fone_tecnico))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid]['val'][0] = $fone_tecnico;
      }
      elseif ($fone_tecnico_cond_salva == "nu" || $fone_tecnico_cond_salva == "nn" || $fone_tecnico_cond_salva == "ep" || $fone_tecnico_cond_salva == "ne" || !empty($fone_tecnico))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid]['val'][0][0] = $fone_tecnico;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca']['fone_tecnico_cond'] = $fone_tecnico_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid]['cmp'] = "fone_tecnico"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid]['opc'] = $fone_tecnico_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq']['fone_tecnico'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca']['nome_tecnico'] = $nome_tecnico; 
      if (is_array($nome_tecnico) && !empty($nome_tecnico))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid]['val'][0] = $nome_tecnico;
      }
      elseif ($nome_tecnico_cond_salva == "nu" || $nome_tecnico_cond_salva == "nn" || $nome_tecnico_cond_salva == "ep" || $nome_tecnico_cond_salva == "ne" || !empty($nome_tecnico))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid]['val'][0][0] = $nome_tecnico;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['campos_busca']['nome_tecnico_cond'] = $nome_tecnico_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid]['cmp'] = "nome_tecnico"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid]['opc'] = $nome_tecnico_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['grid_pesq']['nome_tecnico'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
    ...
    if ($fone_tecnico != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['fone_tecnico'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['fone_tecnico'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['fone_tecnico'] = $fone_tecnico;
      }
      $Conteudo = $id_tecnico;
      if (strtoupper($id_tecnico_cond) != "II" && strtoupper($id_tecnico_cond) != "QP" && strtoupper($id_tecnico_cond) != "NP" && strtoupper($id_tecnico_cond) != "IN") 
      { 
    ...
    if ($nome_tecnico != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['nome_tecnico'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['nome_tecnico'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nome_tecnico'] = $nome_tecnico;
      }
      $nmgp_def_dados = array();
    if ($email_tecnico != '') {
      $email_tecnico_look = substr($this->Db->qstr($email_tecnico), 1, -1); 
      ...
      if (isset($fone_tecnico) || $fone_tecnico_cond == "nu" || $fone_tecnico_cond == "nn" || $fone_tecnico_cond == "ep" || $fone_tecnico_cond == "ne")
      {
         $this->monta_condicao("fone_tecnico", $fone_tecnico_cond, $fone_tecnico, "", "fone_tecnico");
      }
      ...
      {
         $this->monta_condicao("id_tecnico", $id_tecnico_cond, $id_tecnico, "", "id_tecnico");
      }

      //----- $nome_tecnico
      $this->Date_part = false;
      if (isset($nome_tecnico) || $nome_tecnico_cond == "nu" || $nome_tecnico_cond == "nn" || $nome_tecnico_cond == "ep" || $nome_tecnico_cond == "ne")
      {
         $this->monta_condicao("nome_tecnico", $nome_tecnico_cond, $nome_tecnico, "", "nome_tecnico");
      }
      ...
      {
         $this->monta_condicao("email_tecnico", $email_tecnico_cond, $email_tecnico, "", "email_tecnico");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tecnicos']['where_pesq_ant'])
      {

 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_fone_tecnico_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['fone_tecnico'])) ? $this->New_label['fone_tecnico'] : "Fone Tecnico"; ?></TD>
...
<INPUT  type="text" id="SC_id_tecnico" name="id_tecnico" value="<?php echo NM_encode_input($id_tecnico) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_nome_tecnico_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['nome_tecnico'])) ? $this->New_label['nome_tecnico'] : "Nome Tecnico"; ?></TD>
     <TD class="scFilterFieldOdd"> 

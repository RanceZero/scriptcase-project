...
<?php
      ...
      $this->sc_lig_target["A_@scinf__@scinf_form_clientes"] = '_self';
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_clientes']['glo_nm_conexao'], $this->root . $this->path_prod, 'Projeto', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if ($nmgp_opcao == 'pdf_det')
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_clientes']['opc_pdf']['pdf_zip'] = (isset($Det_pdf_zip) && !empty($Det_pdf_zip)) ? $Det_pdf_zip : "N";
          if ($Det_use_pass_pdf != "__APL__")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['use_pass_pdf'] = $Det_use_pass_pdf;
          } 
          $nmgp_opcao = 'pdf';
      }
      if ($nmgp_opcao == 'pdf')
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['field_order'][] = "nome_cliente";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['field_order'][] = "email_cliente";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['field_order'][] = "fone_cliente";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['field_order'][] = "endereco_cliente";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['field_order'][] = "cidade_cliente";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['field_order'][] = "estado_cliente";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['field_order'][] = "pais_cliente";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['field_order'][] = "cep_cliente";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['usr_cmp_sel']['id_cliente'] = "off";
      ...
      { 
          ...
          {
              $this->Ini->Export_img_zip = true;
              $nm_arquivo_html = "/sc_grid_clientes_det_" . session_id() . ".html";
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_html);
          }
      } 
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_clientes']['glo_nm_path_imag_temp'] . "/sc_apl_default_Projeto.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_clientes']['glo_nm_path_imag_temp'] . "/sc_apl_default_Projeto.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_Projeto'])) {
               $_SESSION['scriptcase']['grid_clientes']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_Projeto'];
           }
       }
   }
   ...
   { 
       ...
       if (isset($Sc_seq_det))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_clientes']['Sc_seq_det'] = $Sc_seq_det;
       } 

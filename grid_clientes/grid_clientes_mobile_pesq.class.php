...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id_cliente";$Nm_numeric[] = "id_cliente";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_nome_cliente_cond" name="nome_cliente_cond" onChange="nm_campos_between(document.getElementById('id_vis_nome_cliente'), this, 'nome_cliente')">
      ...
      <br><span id="id_hide_nome_cliente"  <?php echo $str_hide_nome_cliente?>><?php
      if ($nome_cliente != "")
      {
      $nome_cliente_look = substr($this->Db->qstr($nome_cliente), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_email_cliente_cond" name="email_cliente_cond" onChange="nm_campos_between(document.getElementById('id_vis_email_cliente'), this, 'email_cliente')">
      ...
      <br><span id="id_hide_email_cliente"  <?php echo $str_hide_email_cliente?>><?php
      if ($email_cliente != "")
      {
      $email_cliente_look = substr($this->Db->qstr($email_cliente), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_fone_cliente_cond" name="fone_cliente_cond" onChange="nm_campos_between(document.getElementById('id_vis_fone_cliente'), this, 'fone_cliente')">
      ...
      <br><span id="id_hide_fone_cliente"  <?php echo $str_hide_fone_cliente?>><?php
      if ($fone_cliente != "")
      {
      $fone_cliente_look = substr($this->Db->qstr($fone_cliente), 1, -1); 
      $nmgp_def_dados = array(); 

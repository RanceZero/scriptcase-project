<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_clientes']['glo_nm_path_imag_temp'] . "/sc_apl_default_Projeto.txt"))
       {
?>
...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['nome_cliente'] = "on";
   $tab_def_campos['nome_cliente'] = "nome_cliente";
   $tab_labels["nome_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["nome_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["nome_cliente"] : "" . $this->Nm_lang['lang_clientes_fld_nome_cliente'] . "";
   ...
   $tab_ger_campos['fone_cliente'] = "on";
   $tab_def_campos['fone_cliente'] = "fone_cliente";
   $tab_labels["fone_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["fone_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["fone_cliente"] : "" . $this->Nm_lang['lang_clientes_fld_fone_cliente'] . "";
   $tab_ger_campos['endereco_cliente'] = "on";
   $tab_def_campos['endereco_cliente'] = "endereco_cliente";
   $tab_labels["endereco_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["endereco_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["endereco_cliente"] : "" . $this->Nm_lang['lang_clientes_fld_endereco_cliente'] . "";
   $tab_ger_campos['cidade_cliente'] = "on";
   $tab_def_campos['cidade_cliente'] = "cidade_cliente";
   $tab_labels["cidade_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["cidade_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["cidade_cliente"] : "" . $this->Nm_lang['lang_clientes_fld_cidade_cliente'] . "";
   $tab_ger_campos['estado_cliente'] = "on";
   $tab_def_campos['estado_cliente'] = "estado_cliente";
   $tab_labels["estado_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["estado_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["estado_cliente"] : "" . $this->Nm_lang['lang_clientes_fld_estado_cliente'] . "";
   $tab_ger_campos['pais_cliente'] = "on";
   $tab_def_campos['pais_cliente'] = "pais_cliente";
   $tab_labels["pais_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["pais_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["pais_cliente"] : "" . $this->Nm_lang['lang_clientes_fld_pais_cliente'] . "";
   $tab_ger_campos['cep_cliente'] = "on";
   $tab_def_campos['cep_cliente'] = "cep_cliente";
   $tab_labels["cep_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["cep_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["cep_cliente"] : "" . $this->Nm_lang['lang_clientes_fld_cep_cliente'] . "";

...
//-- ajax metodos ---
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nome_cliente')
      {
          $nome_cliente = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nome_cliente($nome_cliente);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_email_cliente')
      {
          $email_cliente = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_email_cliente($email_cliente);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_fone_cliente')
      {
          $fone_cliente = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_fone_cliente($fone_cliente);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> <?php echo $this->Ini->Nm_lang['lang_tbl_clientes'] ?></TITLE>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_nome_cliente_cond#NMF#' + search_get_sel_txt('SC_nome_cliente_cond') + '@NMF@';
  str_out += 'SC_nome_cliente#NMF#' + search_get_text('SC_nome_cliente') + '@NMF@';
  str_out += 'id_ac_nome_cliente#NMF#' + search_get_text('id_ac_nome_cliente') + '@NMF@';
  str_out += 'SC_email_cliente_cond#NMF#' + search_get_sel_txt('SC_email_cliente_cond') + '@NMF@';
  str_out += 'SC_email_cliente#NMF#' + search_get_text('SC_email_cliente') + '@NMF@';
  str_out += 'id_ac_email_cliente#NMF#' + search_get_text('id_ac_email_cliente') + '@NMF@';
  str_out += 'SC_fone_cliente_cond#NMF#' + search_get_sel_txt('SC_fone_cliente_cond') + '@NMF@';
  str_out += 'SC_fone_cliente#NMF#' + search_get_text('SC_fone_cliente') + '@NMF@';
  str_out += 'id_ac_fone_cliente#NMF#' + search_get_text('id_ac_fone_cliente') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_nome_cliente").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_nome_cliente").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_nome_cliente",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_nome_cliente").val(ui.item.value);
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_nome_cliente").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_email_cliente").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_email_cliente").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_email_cliente",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_email_cliente").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_email_cliente").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_fone_cliente").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_fone_cliente").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_fone_cliente",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_fone_cliente").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> <?php echo $this->Ini->Nm_lang['lang_tbl_clientes'] ?></div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $nome_cliente_cond, $nome_cliente, $nome_cliente_autocomp,
             $email_cliente_cond, $email_cliente, $email_cliente_autocomp,
             $fone_cliente_cond, $fone_cliente, $fone_cliente_autocomp,
      ...
      { 
          ...
          $nome_cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['nome_cliente']; 
          $nome_cliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['nome_cliente_cond']; 
          $email_cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['email_cliente']; 
          $email_cliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['email_cliente_cond']; 
          $fone_cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['fone_cliente']; 
          $fone_cliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['fone_cliente_cond']; 
      ...
      if (!isset($nome_cliente_cond) || empty($nome_cliente_cond))
      {
         $nome_cliente_cond = "qp";
      }
      if (!isset($email_cliente_cond) || empty($email_cliente_cond))
      {
         $email_cliente_cond = "qp";
      }
      if (!isset($fone_cliente_cond) || empty($fone_cliente_cond))
      {
         $fone_cliente_cond = "qp";
      }
      ...
      $str_hide_nome_cliente = (in_array($nome_cliente_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_email_cliente = (in_array($email_cliente_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_fone_cliente = (in_array($fone_cliente_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (!isset($nome_cliente) || $nome_cliente == "")
      {
          $nome_cliente = "";
      }
      if (isset($nome_cliente) && !empty($nome_cliente))
      {
         $tmp_pos = strpos($nome_cliente, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $nome_cliente = substr($nome_cliente, 0, $tmp_pos);
         }
      }
      if (!isset($email_cliente) || $email_cliente == "")
      {
          $email_cliente = "";
      }
      if (isset($email_cliente) && !empty($email_cliente))
      {
         $tmp_pos = strpos($email_cliente, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $email_cliente = substr($email_cliente, 0, $tmp_pos);
         }
      }
      if (!isset($fone_cliente) || $fone_cliente == "")
      {
          $fone_cliente = "";
      }
      if (isset($fone_cliente) && !empty($fone_cliente))
      {
         $tmp_pos = strpos($fone_cliente, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $fone_cliente = substr($fone_cliente, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_id_cliente_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_cliente'])) ? $this->New_label['id_cliente'] : "" . $this->Ini->Nm_lang['lang_clientes_fld_id_cliente'] . ""; ?></TD>
...
<INPUT  type="text" id="SC_id_cliente" name="id_cliente" value="<?php echo NM_encode_input($id_cliente) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_nome_cliente_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['nome_cliente'])) ? $this->New_label['nome_cliente'] : "" . $this->Ini->Nm_lang['lang_clientes_fld_nome_cliente'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_nome_cliente_cond" name="nome_cliente_cond" onChange="nm_campos_between(document.getElementById('id_vis_nome_cliente'), this, 'nome_cliente')">
       <OPTION value="qp" <?php if ("qp" == $nome_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $nome_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nome_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $nome_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nome_cliente" <?php echo $str_hide_nome_cliente?> valign="top">
 ...
 $nmgp_tab_label .= "nome_cliente?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $nome_cliente;
      }
?>
<INPUT  type="text" id="SC_nome_cliente" name="nome_cliente" value="<?php echo NM_encode_input($nome_cliente) ?>"  size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_nome_cliente" name="nome_cliente_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_email_cliente_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['email_cliente'])) ? $this->New_label['email_cliente'] : "" . $this->Ini->Nm_lang['lang_clientes_fld_email_cliente'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_email_cliente_cond" name="email_cliente_cond" onChange="nm_campos_between(document.getElementById('id_vis_email_cliente'), this, 'email_cliente')">
       <OPTION value="qp" <?php if ("qp" == $email_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $email_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $email_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $email_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_email_cliente" <?php echo $str_hide_email_cliente?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 ...
 $nmgp_tab_label .= "email_cliente?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $email_cliente;
      }
?>
<INPUT  type="text" id="SC_email_cliente" name="email_cliente" value="<?php echo NM_encode_input($email_cliente) ?>"  size=50 alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_email_cliente" name="email_cliente_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_fone_cliente_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['fone_cliente'])) ? $this->New_label['fone_cliente'] : "" . $this->Ini->Nm_lang['lang_clientes_fld_fone_cliente'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_fone_cliente_cond" name="fone_cliente_cond" onChange="nm_campos_between(document.getElementById('id_vis_fone_cliente'), this, 'fone_cliente')">
       <OPTION value="qp" <?php if ("qp" == $fone_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $fone_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $fone_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $fone_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fone_cliente" <?php echo $str_hide_fone_cliente?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['fone_cliente'])) ? $this->New_label['fone_cliente'] : "" . $this->Ini->Nm_lang['lang_clientes_fld_fone_cliente'] . "";
 $nmgp_tab_label .= "fone_cliente?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $fone_cliente;
      }
?>
<INPUT  type="text" id="SC_fone_cliente" name="fone_cliente" value="<?php echo NM_encode_input($fone_cliente) ?>"  size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_fone_cliente" name="fone_cliente_autocomp" size="20"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.nome_cliente_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_nome_cliente'), document.F1.nome_cliente_cond, 'nome_cliente');
   document.F1.nome_cliente.value = "";
   document.F1.nome_cliente_autocomp.value = "";
   document.F1.email_cliente_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_email_cliente'), document.F1.email_cliente_cond, 'email_cliente');
   document.F1.email_cliente.value = "";
   document.F1.email_cliente_autocomp.value = "";
   document.F1.fone_cliente_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_fone_cliente'), document.F1.fone_cliente_cond, 'fone_cliente');
   document.F1.fone_cliente.value = "";
   document.F1.fone_cliente_autocomp.value = "";
 }
...
<?php
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_nome_cliente_cond'] = 'cond';
      $tp_fields['SC_nome_cliente'] = 'text_aut';
      $tp_fields['id_ac_nome_cliente'] = 'text_aut';
      $tp_fields['SC_email_cliente_cond'] = 'cond';
      $tp_fields['SC_email_cliente'] = 'text_aut';
      $tp_fields['id_ac_email_cliente'] = 'text_aut';
      $tp_fields['SC_fone_cliente_cond'] = 'cond';
      $tp_fields['SC_fone_cliente'] = 'text_aut';
      $tp_fields['id_ac_fone_cliente'] = 'text_aut';
   ...
   {
      global $id_cliente_cond, $id_cliente,
             $nome_cliente_cond, $nome_cliente, $nome_cliente_autocomp,
             $email_cliente_cond, $email_cliente, $email_cliente_autocomp,
             $fone_cliente_cond, $fone_cliente, $fone_cliente_autocomp, $nmgp_tab_label;
      ...
      if (!empty($nome_cliente_autocomp) && empty($nome_cliente))
      {
          $nome_cliente = $nome_cliente_autocomp;
      }
      if (!empty($email_cliente_autocomp) && empty($email_cliente))
      {
          $email_cliente = $email_cliente_autocomp;
      }
      if (!empty($fone_cliente_autocomp) && empty($fone_cliente))
      {
          $fone_cliente = $fone_cliente_autocomp;
      }
      ...
      $nome_cliente_cond_salva = $nome_cliente_cond; 
      if (!isset($nome_cliente_input_2) || $nome_cliente_input_2 == "")
      {
          $nome_cliente_input_2 = $nome_cliente;
      }
      $email_cliente_cond_salva = $email_cliente_cond; 
      if (!isset($email_cliente_input_2) || $email_cliente_input_2 == "")
      {
          $email_cliente_input_2 = $email_cliente;
      }
      $fone_cliente_cond_salva = $fone_cliente_cond; 
      if (!isset($fone_cliente_input_2) || $fone_cliente_input_2 == "")
      {
          $fone_cliente_input_2 = $fone_cliente;
      }
      if ($id_cliente_cond != "in")
      {
          nm_limpa_numero($id_cliente, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $this->nm_tira_mask($fone_cliente, "(xx) xxxxx-xxxx");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']  = array(); 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['Grid_search'][$I_Grid]['val'][0] = $id_cliente;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['Grid_search'][$I_Grid]['val'][0][0] = $id_cliente;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['id_cliente_cond'] = $id_cliente_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['Grid_search'][$I_Grid]['cmp'] = "id_cliente"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['Grid_search'][$I_Grid]['opc'] = $id_cliente_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['grid_pesq']['id_cliente'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['nome_cliente'] = $nome_cliente; 
      if (is_array($nome_cliente) && !empty($nome_cliente))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['Grid_search'][$I_Grid]['val'][0] = $nome_cliente;
      }
      elseif ($nome_cliente_cond_salva == "nu" || $nome_cliente_cond_salva == "nn" || $nome_cliente_cond_salva == "ep" || $nome_cliente_cond_salva == "ne" || !empty($nome_cliente))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['Grid_search'][$I_Grid]['val'][0][0] = $nome_cliente;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['nome_cliente_cond'] = $nome_cliente_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['Grid_search'][$I_Grid]['cmp'] = "nome_cliente"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['Grid_search'][$I_Grid]['opc'] = $nome_cliente_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['grid_pesq']['nome_cliente'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['email_cliente'] = $email_cliente; 
      if (is_array($email_cliente) && !empty($email_cliente))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['Grid_search'][$I_Grid]['val'][0] = $email_cliente;
      }
      elseif ($email_cliente_cond_salva == "nu" || $email_cliente_cond_salva == "nn" || $email_cliente_cond_salva == "ep" || $email_cliente_cond_salva == "ne" || !empty($email_cliente))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['Grid_search'][$I_Grid]['val'][0][0] = $email_cliente;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['email_cliente_cond'] = $email_cliente_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['Grid_search'][$I_Grid]['cmp'] = "email_cliente"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['Grid_search'][$I_Grid]['opc'] = $email_cliente_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['grid_pesq']['email_cliente'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['fone_cliente'] = $fone_cliente; 
      if (is_array($fone_cliente) && !empty($fone_cliente))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['Grid_search'][$I_Grid]['val'][0] = $fone_cliente;
      }
      elseif ($fone_cliente_cond_salva == "nu" || $fone_cliente_cond_salva == "nn" || $fone_cliente_cond_salva == "ep" || $fone_cliente_cond_salva == "ne" || !empty($fone_cliente))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['Grid_search'][$I_Grid]['val'][0][0] = $fone_cliente;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['fone_cliente_cond'] = $fone_cliente_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['Grid_search'][$I_Grid]['cmp'] = "fone_cliente"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['Grid_search'][$I_Grid]['opc'] = $fone_cliente_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['grid_pesq']['fone_cliente'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
    ...
    if ($nome_cliente != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['nome_cliente'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['nome_cliente'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nome_cliente'] = $nome_cliente;
      }
      $nmgp_def_dados = array();
    if ($email_cliente != '') {
      $email_cliente_look = substr($this->Db->qstr($email_cliente), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['email_cliente'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['email_cliente'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['email_cliente'] = $email_cliente;
      }
      $nmgp_def_dados = array();
    if ($fone_cliente != '') {
      $fone_cliente_look = substr($this->Db->qstr($fone_cliente), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['fone_cliente'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['fone_cliente'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['fone_cliente'] = $fone_cliente;
      }
      ...
      //----- $nome_cliente
      $this->Date_part = false;
      if (isset($nome_cliente) || $nome_cliente_cond == "nu" || $nome_cliente_cond == "nn" || $nome_cliente_cond == "ep" || $nome_cliente_cond == "ne")
      {
         $this->monta_condicao("nome_cliente", $nome_cliente_cond, $nome_cliente, "", "nome_cliente");
      }

      //----- $email_cliente
      $this->Date_part = false;
      if (isset($email_cliente) || $email_cliente_cond == "nu" || $email_cliente_cond == "nn" || $email_cliente_cond == "ep" || $email_cliente_cond == "ne")
      {
         $this->monta_condicao("email_cliente", $email_cliente_cond, $email_cliente, "", "email_cliente");
      }

      //----- $fone_cliente
      $this->Date_part = false;
      if (isset($fone_cliente) || $fone_cliente_cond == "nu" || $fone_cliente_cond == "nn" || $fone_cliente_cond == "ep" || $fone_cliente_cond == "ne")
      {
         $this->monta_condicao("fone_cliente", $fone_cliente_cond, $fone_cliente, "", "fone_cliente");
      }
   }

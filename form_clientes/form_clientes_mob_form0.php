...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nome_cliente_line" id="hidden_field_data_nome_cliente" style="<?php echo $sStyleHidden_nome_cliente; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nome_cliente_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_nome_cliente_label" style=""><span id="id_label_nome_cliente"><?php echo $this->nm_new_label['nome_cliente']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_email_cliente_line" id="hidden_field_data_email_cliente" style="<?php echo $sStyleHidden_email_cliente; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_email_cliente_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_email_cliente_label" style=""><span id="id_label_email_cliente"><?php echo $this->nm_new_label['email_cliente']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fone_cliente_line" id="hidden_field_data_fone_cliente" style="<?php echo $sStyleHidden_fone_cliente; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fone_cliente_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fone_cliente_label" style=""><span id="id_label_fone_cliente"><?php echo $this->nm_new_label['fone_cliente']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_endereco_cliente_line" id="hidden_field_data_endereco_cliente" style="<?php echo $sStyleHidden_endereco_cliente; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_endereco_cliente_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_endereco_cliente_label" style=""><span id="id_label_endereco_cliente"><?php echo $this->nm_new_label['endereco_cliente']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cidade_cliente_line" id="hidden_field_data_cidade_cliente" style="<?php echo $sStyleHidden_cidade_cliente; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cidade_cliente_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cidade_cliente_label" style=""><span id="id_label_cidade_cliente"><?php echo $this->nm_new_label['cidade_cliente']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_estado_cliente_line" id="hidden_field_data_estado_cliente" style="<?php echo $sStyleHidden_estado_cliente; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_estado_cliente_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_estado_cliente_label" style=""><span id="id_label_estado_cliente"><?php echo $this->nm_new_label['estado_cliente']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pais_cliente_line" id="hidden_field_data_pais_cliente" style="<?php echo $sStyleHidden_pais_cliente; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pais_cliente_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_pais_cliente_label" style=""><span id="id_label_pais_cliente"><?php echo $this->nm_new_label['pais_cliente']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cep_cliente_line" id="hidden_field_data_cep_cliente" style="<?php echo $sStyleHidden_cep_cliente; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cep_cliente_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cep_cliente_label" style=""><span id="id_label_cep_cliente"><?php echo $this->nm_new_label['cep_cliente']; ?></span></span><br>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['usuario_cliente']))
    {
...
<?php
   ...
   $sStyleHidden_usuario_cliente = '';
   if (isset($this->nmgp_cmp_hidden['usuario_cliente']) && $this->nmgp_cmp_hidden['usuario_cliente'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['usuario_cliente']);
       $sStyleHidden_usuario_cliente = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_usuario_cliente = 'display: none;';
   $sStyleReadInp_usuario_cliente = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['usuario_cliente']) && $this->nmgp_cmp_readonly['usuario_cliente'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['usuario_cliente']);
       $sStyleReadLab_usuario_cliente = '';
       $sStyleReadInp_usuario_cliente = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['usuario_cliente']) && $this->nmgp_cmp_hidden['usuario_cliente'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="usuario_cliente" value="<?php echo $this->form_encode_input($usuario_cliente) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_usuario_cliente_line" id="hidden_field_data_usuario_cliente" style="<?php echo $sStyleHidden_usuario_cliente; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_usuario_cliente_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_usuario_cliente_label" style=""><span id="id_label_usuario_cliente"><?php echo $this->nm_new_label['usuario_cliente']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["usuario_cliente"]) &&  $this->nmgp_cmp_readonly["usuario_cliente"] == "on") { 

 ?>
<input type="hidden" name="usuario_cliente" value="<?php echo $this->form_encode_input($usuario_cliente) . "\">" . $usuario_cliente . ""; ?>
<?php } else { ?>
<span id="id_read_on_usuario_cliente" class="sc-ui-readonly-usuario_cliente css_usuario_cliente_line" style="<?php echo $sStyleReadLab_usuario_cliente; ?>"><?php echo $this->form_format_readonly("usuario_cliente", $this->form_encode_input($this->usuario_cliente)); ?></span><span id="id_read_off_usuario_cliente" class="css_read_off_usuario_cliente<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_usuario_cliente; ?>">
 <input class="sc-js-input scFormObjectOdd css_usuario_cliente_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_usuario_cliente" type=text name="usuario_cliente" value="<?php echo $this->form_encode_input($usuario_cliente) ?>"
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_usuario_cliente_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_usuario_cliente_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>

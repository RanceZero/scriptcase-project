...
<?php 
          ...
          $SC_Label_atu['usuario_cliente'] = (isset($this->nm_new_label['usuario_cliente'])) ? $this->nm_new_label['usuario_cliente'] : '' . $this->Ini->Nm_lang['lang_clientes_fld_usuario_cliente'] . ''; 
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormDataOdd css_id_cliente_line" id="hidden_field_data_id_cliente" style="<?php echo $sStyleHidden_id_cliente; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_cliente_line" style="vertical-align: top;padding: 0px"><span id="id_read_on_id_cliente" class="css_id_cliente_line" style="<?php echo $sStyleReadLab_id_cliente; ?>"><?php echo $this->form_format_readonly("id_cliente", $this->form_encode_input($this->id_cliente)); ?></span><span id="id_read_off_id_cliente" class="css_read_off_id_cliente" style="<?php echo $sStyleReadInp_id_cliente; ?>"><input type="hidden" name="id_cliente" value="<?php echo $this->form_encode_input($id_cliente) . "\">"?><span id="id_ajax_label_id_cliente"><?php echo nl2br($id_cliente); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nome_cliente_label" id="hidden_field_label_nome_cliente" style="<?php echo $sStyleHidden_nome_cliente; ?>"><span id="id_label_nome_cliente"><?php echo $this->nm_new_label['nome_cliente']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_usuario_cliente_label" id="hidden_field_label_usuario_cliente" style="<?php echo $sStyleHidden_usuario_cliente; ?>"><span id="id_label_usuario_cliente"><?php echo $this->nm_new_label['usuario_cliente']; ?></span></TD>
    <TD class="scFormDataOdd css_usuario_cliente_line" id="hidden_field_data_usuario_cliente" style="<?php echo $sStyleHidden_usuario_cliente; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_usuario_cliente_line" style="vertical-align: top;padding: 0px">

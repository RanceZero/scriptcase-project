...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["usuario_cliente" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
}
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["usuario_cliente" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["usuario_cliente" + iSeqRow]["change"]) {
    return true;
  }
  return false;
...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_usuario_cliente' + iSeqRow).bind('blur', function() { sc_form_clientes_usuario_cliente_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_clientes_usuario_cliente_onfocus(this, iSeqRow) });
} // scJQEventsAdd
...
function sc_form_clientes_usuario_cliente_onblur(oThis, iSeqRow) {
  do_ajax_form_clientes_mob_validate_usuario_cliente();
  scCssBlur(oThis);
}

function sc_form_clientes_usuario_cliente_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_block_0(status) {
	...
	displayChange_field("usuario_cliente", "", status);
}
...
function displayChange_row(row, status) {
	...
	displayChange_field_usuario_cliente(row, status);
}
...
function displayChange_field_usuario_cliente(row, status) {
}

...
?>
  ...
  function do_ajax_form_clientes_validate_nome_cliente()
  {
    var nomeCampo_nome_cliente = "nome_cliente";
    var var_nome_cliente = scAjaxGetFieldText(nomeCampo_nome_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_validate_nome_cliente(var_nome_cliente, var_script_case_init, do_ajax_form_clientes_validate_nome_cliente_cb);
  } // do_ajax_form_clientes_validate_nome_cliente

  function do_ajax_form_clientes_validate_nome_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_validate_nome_cliente_cb
  ...
  function do_ajax_form_clientes_validate_fone_cliente()
  {
    var nomeCampo_fone_cliente = "fone_cliente";
    var var_fone_cliente = scAjaxGetFieldText(nomeCampo_fone_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_validate_fone_cliente(var_fone_cliente, var_script_case_init, do_ajax_form_clientes_validate_fone_cliente_cb);
  } // do_ajax_form_clientes_validate_fone_cliente

  function do_ajax_form_clientes_validate_fone_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_validate_fone_cliente_cb

  // ---------- Validate endereco_cliente
  function do_ajax_form_clientes_validate_endereco_cliente()
  {
    var nomeCampo_endereco_cliente = "endereco_cliente";
    var var_endereco_cliente = scAjaxGetFieldText(nomeCampo_endereco_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_validate_endereco_cliente(var_endereco_cliente, var_script_case_init, do_ajax_form_clientes_validate_endereco_cliente_cb);
  } // do_ajax_form_clientes_validate_endereco_cliente

  function do_ajax_form_clientes_validate_endereco_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_validate_endereco_cliente_cb

  // ---------- Validate cidade_cliente
  function do_ajax_form_clientes_validate_cidade_cliente()
  {
    var nomeCampo_cidade_cliente = "cidade_cliente";
    var var_cidade_cliente = scAjaxGetFieldText(nomeCampo_cidade_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_validate_cidade_cliente(var_cidade_cliente, var_script_case_init, do_ajax_form_clientes_validate_cidade_cliente_cb);
  } // do_ajax_form_clientes_validate_cidade_cliente

  function do_ajax_form_clientes_validate_cidade_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_validate_cidade_cliente_cb

  // ---------- Validate estado_cliente
  function do_ajax_form_clientes_validate_estado_cliente()
  {
    var nomeCampo_estado_cliente = "estado_cliente";
    var var_estado_cliente = scAjaxGetFieldText(nomeCampo_estado_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_validate_estado_cliente(var_estado_cliente, var_script_case_init, do_ajax_form_clientes_validate_estado_cliente_cb);
  } // do_ajax_form_clientes_validate_estado_cliente

  function do_ajax_form_clientes_validate_estado_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_validate_estado_cliente_cb
  ...
  function do_ajax_form_clientes_validate_pais_cliente()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_validate_pais_cliente(var_pais_cliente, var_script_case_init, do_ajax_form_clientes_validate_pais_cliente_cb);
  ...
  function do_ajax_form_clientes_validate_cep_cliente()
  {
    var nomeCampo_cep_cliente = "cep_cliente";
    var var_cep_cliente = scAjaxGetFieldText(nomeCampo_cep_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_validate_cep_cliente(var_cep_cliente, var_script_case_init, do_ajax_form_clientes_validate_cep_cliente_cb);
  } // do_ajax_form_clientes_validate_cep_cliente

  function do_ajax_form_clientes_validate_cep_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_validate_cep_cliente_cb

  // ---------- Validate usuario_cliente
  function do_ajax_form_clientes_validate_usuario_cliente()
  {
    var nomeCampo_usuario_cliente = "usuario_cliente";
    var var_usuario_cliente = scAjaxGetFieldText(nomeCampo_usuario_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_validate_usuario_cliente(var_usuario_cliente, var_script_case_init, do_ajax_form_clientes_validate_usuario_cliente_cb);
  } // do_ajax_form_clientes_validate_usuario_cliente

  function do_ajax_form_clientes_validate_usuario_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_validate_usuario_cliente_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_clientes_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_clientes_submit_form(var_id_cliente, var_nome_cliente, var_email_cliente, var_fone_cliente, var_endereco_cliente, var_cidade_cliente, var_estado_cliente, var_pais_cliente, var_cep_cliente, var_usuario_cliente, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_clientes_submit_form_cb);

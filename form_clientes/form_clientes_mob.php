...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
...
//
    ...
    if (isset($_POST['rs']) && !is_array($_POST['rs']) && 'ajax_' == substr($_POST['rs'], 0, 5) && isset($_POST['rsargs']) && !empty($_POST['rsargs']) && !isset($_SESSION['scriptcase']['form_clientes_mob']['session_timeout']['redir']))
    {
        ...
        if ('ajax_form_clientes_mob_validate_usuario_cliente' == $_POST['rs'])
        {
    ...
    sajax_export("ajax_form_clientes_mob_validate_usuario_cliente");
...
//
    ...
    function ajax_form_clientes_mob_validate_usuario_cliente($usuario_cliente, $script_case_init)
    {
        global $inicial_form_clientes_mob;
        //register_shutdown_function("form_clientes_mob_pack_ajax_response");
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_flag          = true;
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_opcao         = 'validate_usuario_cliente';
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_clientes_mob_submit_form($id_cliente, $nome_cliente, $email_cliente, $fone_cliente, $endereco_cliente, $cidade_cliente, $estado_cliente, $pais_cliente, $cep_cliente, $usuario_cliente, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token)
    {
        global $inicial_form_clientes_mob;
        //register_shutdown_function("form_clientes_mob_pack_ajax_response");
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_flag          = true;

...
?>
  ...
  function do_ajax_form_clientes_mob_validate_nome_cliente()
  {
    var nomeCampo_nome_cliente = "nome_cliente";
    var var_nome_cliente = scAjaxGetFieldText(nomeCampo_nome_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mob_validate_nome_cliente(var_nome_cliente, var_script_case_init, do_ajax_form_clientes_mob_validate_nome_cliente_cb);
  } // do_ajax_form_clientes_mob_validate_nome_cliente

  function do_ajax_form_clientes_mob_validate_nome_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mob_validate_nome_cliente_cb
  ...
  // ---------- Validate fone_cliente
  function do_ajax_form_clientes_mob_validate_fone_cliente()
  {
    var nomeCampo_fone_cliente = "fone_cliente";
    var var_fone_cliente = scAjaxGetFieldText(nomeCampo_fone_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mob_validate_fone_cliente(var_fone_cliente, var_script_case_init, do_ajax_form_clientes_mob_validate_fone_cliente_cb);
  } // do_ajax_form_clientes_mob_validate_fone_cliente

  function do_ajax_form_clientes_mob_validate_fone_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fone_cliente";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mob_validate_fone_cliente_cb

  // ---------- Validate endereco_cliente
  function do_ajax_form_clientes_mob_validate_endereco_cliente()
  {
    var nomeCampo_endereco_cliente = "endereco_cliente";
    var var_endereco_cliente = scAjaxGetFieldText(nomeCampo_endereco_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mob_validate_endereco_cliente(var_endereco_cliente, var_script_case_init, do_ajax_form_clientes_mob_validate_endereco_cliente_cb);
  } // do_ajax_form_clientes_mob_validate_endereco_cliente

  function do_ajax_form_clientes_mob_validate_endereco_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "endereco_cliente";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mob_validate_endereco_cliente_cb

  // ---------- Validate cidade_cliente
  function do_ajax_form_clientes_mob_validate_cidade_cliente()
  {
    var nomeCampo_cidade_cliente = "cidade_cliente";
    var var_cidade_cliente = scAjaxGetFieldText(nomeCampo_cidade_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mob_validate_cidade_cliente(var_cidade_cliente, var_script_case_init, do_ajax_form_clientes_mob_validate_cidade_cliente_cb);
  } // do_ajax_form_clientes_mob_validate_cidade_cliente

  function do_ajax_form_clientes_mob_validate_cidade_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cidade_cliente";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mob_validate_cidade_cliente_cb

  // ---------- Validate estado_cliente
  function do_ajax_form_clientes_mob_validate_estado_cliente()
  {
    var nomeCampo_estado_cliente = "estado_cliente";
    var var_estado_cliente = scAjaxGetFieldText(nomeCampo_estado_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mob_validate_estado_cliente(var_estado_cliente, var_script_case_init, do_ajax_form_clientes_mob_validate_estado_cliente_cb);
  } // do_ajax_form_clientes_mob_validate_estado_cliente

  function do_ajax_form_clientes_mob_validate_estado_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estado_cliente";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mob_validate_estado_cliente_cb
  ...
  function do_ajax_form_clientes_mob_validate_pais_cliente()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mob_validate_pais_cliente(var_pais_cliente, var_script_case_init, do_ajax_form_clientes_mob_validate_pais_cliente_cb);
  ...
  // ---------- Validate cep_cliente
  function do_ajax_form_clientes_mob_validate_cep_cliente()
  {
    var nomeCampo_cep_cliente = "cep_cliente";
    var var_cep_cliente = scAjaxGetFieldText(nomeCampo_cep_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mob_validate_cep_cliente(var_cep_cliente, var_script_case_init, do_ajax_form_clientes_mob_validate_cep_cliente_cb);
  } // do_ajax_form_clientes_mob_validate_cep_cliente

  function do_ajax_form_clientes_mob_validate_cep_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cep_cliente";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mob_validate_cep_cliente_cb

  // ---------- Validate usuario_cliente
  function do_ajax_form_clientes_mob_validate_usuario_cliente()
  {
    var nomeCampo_usuario_cliente = "usuario_cliente";
    var var_usuario_cliente = scAjaxGetFieldText(nomeCampo_usuario_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mob_validate_usuario_cliente(var_usuario_cliente, var_script_case_init, do_ajax_form_clientes_mob_validate_usuario_cliente_cb);
  } // do_ajax_form_clientes_mob_validate_usuario_cliente

  function do_ajax_form_clientes_mob_validate_usuario_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario_cliente";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mob_validate_usuario_cliente_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_clientes_mob_submit_form()
  {
    ...
    var var_nome_cliente = scAjaxGetFieldText("nome_cliente");
    var var_email_cliente = scAjaxGetFieldText("email_cliente");
    var var_fone_cliente = scAjaxGetFieldText("fone_cliente");
    var var_endereco_cliente = scAjaxGetFieldText("endereco_cliente");
    var var_cidade_cliente = scAjaxGetFieldText("cidade_cliente");
    var var_estado_cliente = scAjaxGetFieldText("estado_cliente");
    var var_pais_cliente = scAjaxGetFieldText("pais_cliente");
    var var_cep_cliente = scAjaxGetFieldText("cep_cliente");
    var var_usuario_cliente = scAjaxGetFieldText("usuario_cliente");
    ...
    scAjaxProcOn();
    x_ajax_form_clientes_mob_submit_form(var_id_cliente, var_nome_cliente, var_email_cliente, var_fone_cliente, var_endereco_cliente, var_cidade_cliente, var_estado_cliente, var_pais_cliente, var_cep_cliente, var_usuario_cliente, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_clientes_mob_submit_form_cb);
  ...
  function do_ajax_form_clientes_mob_submit_form_cb(sResp)
  {
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("fone_cliente");
      scAjaxHideErrorDisplay("endereco_cliente");
      scAjaxHideErrorDisplay("cidade_cliente");
      scAjaxHideErrorDisplay("estado_cliente");
      scAjaxHideErrorDisplay("pais_cliente");
      scAjaxHideErrorDisplay("cep_cliente");
      scAjaxHideErrorDisplay("usuario_cliente");
      scLigEditLookupCall();
<?php
...
?>
  ...
  ajax_field_list[1] = "nome_cliente";
  ajax_field_list[2] = "email_cliente";
  ajax_field_list[3] = "fone_cliente";
  ajax_field_list[4] = "endereco_cliente";
  ajax_field_list[5] = "cidade_cliente";
  ajax_field_list[6] = "estado_cliente";
  ajax_field_list[7] = "pais_cliente";
  ajax_field_list[8] = "cep_cliente";
  ajax_field_list[9] = "usuario_cliente";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_cliente": {"label": "<?php echo $this->Ini->Nm_lang['lang_clientes_fld_id_cliente'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nome_cliente": {"label": "<?php echo $this->Ini->Nm_lang['lang_clientes_fld_nome_cliente'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "email_cliente": {"label": "<?php echo $this->Ini->Nm_lang['lang_clientes_fld_email_cliente'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fone_cliente": {"label": "<?php echo $this->Ini->Nm_lang['lang_clientes_fld_fone_cliente'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "endereco_cliente": {"label": "<?php echo $this->Ini->Nm_lang['lang_clientes_fld_endereco_cliente'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cidade_cliente": {"label": "<?php echo $this->Ini->Nm_lang['lang_clientes_fld_cidade_cliente'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "estado_cliente": {"label": "<?php echo $this->Ini->Nm_lang['lang_clientes_fld_estado_cliente'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pais_cliente": {"label": "<?php echo $this->Ini->Nm_lang['lang_clientes_fld_pais_cliente'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cep_cliente": {"label": "<?php echo $this->Ini->Nm_lang['lang_clientes_fld_cep_cliente'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usuario_cliente": {"label": "<?php echo $this->Ini->Nm_lang['lang_clientes_fld_usuario_cliente'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "fone_cliente": new Array(),
    "endereco_cliente": new Array(),
    "cidade_cliente": new Array(),
    "estado_cliente": new Array(),
    "pais_cliente": new Array(),
    "cep_cliente": new Array(),
    "usuario_cliente": new Array()
  };
  ...
  ajax_field_mult["fone_cliente"][1] = "fone_cliente";
  ajax_field_mult["endereco_cliente"][1] = "endereco_cliente";
  ajax_field_mult["cidade_cliente"][1] = "cidade_cliente";
  ajax_field_mult["estado_cliente"][1] = "estado_cliente";
  ajax_field_mult["pais_cliente"][1] = "pais_cliente";
  ajax_field_mult["cep_cliente"][1] = "cep_cliente";
  ajax_field_mult["usuario_cliente"][1] = "usuario_cliente";
  ...
  var ajax_field_id = {
    ...
    "fone_cliente": new Array("hidden_field_label_fone_cliente", "hidden_field_data_fone_cliente"),
    "endereco_cliente": new Array("hidden_field_label_endereco_cliente", "hidden_field_data_endereco_cliente"),
    "cidade_cliente": new Array("hidden_field_label_cidade_cliente", "hidden_field_data_cidade_cliente"),
    "estado_cliente": new Array("hidden_field_label_estado_cliente", "hidden_field_data_estado_cliente"),
    "pais_cliente": new Array("hidden_field_label_pais_cliente", "hidden_field_data_pais_cliente"),
    "cep_cliente": new Array("hidden_field_label_cep_cliente", "hidden_field_data_cep_cliente"),
    "usuario_cliente": new Array("hidden_field_label_usuario_cliente", "hidden_field_data_usuario_cliente")
  };

...
?>
  ...
  function do_ajax_form_clientes_mob_validate_pais_cliente()
  {
    ...
    var var_pais_cliente = scAjaxGetFieldSelect(nomeCampo_pais_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_clientes_mob_submit_form()
  {
    ...
    var var_pais_cliente = scAjaxGetFieldSelect("pais_cliente");
    ...
    scAjaxProcOn();
    x_ajax_form_clientes_mob_submit_form(var_nome_cliente, var_fone_cliente, var_email_cliente, var_endereco_cliente, var_cidade_cliente, var_estado_cliente, var_pais_cliente, var_cep_cliente, var_id_cliente, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_clientes_mob_submit_form_cb);
...
?>
  ...
  ajax_field_list[0] = "nome_cliente";
  ajax_field_list[1] = "fone_cliente";
  ajax_field_list[2] = "email_cliente";
  ajax_field_list[3] = "endereco_cliente";
  ajax_field_list[4] = "cidade_cliente";
  ajax_field_list[5] = "estado_cliente";
  ajax_field_list[6] = "pais_cliente";
  ajax_field_list[7] = "cep_cliente";

...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_clientes_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_clientes_submit_form(var_nome_cliente, var_fone_cliente, var_email_cliente, var_endereco_cliente, var_cidade_cliente, var_estado_cliente, var_pais_cliente, var_cep_cliente, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_clientes_submit_form_cb);

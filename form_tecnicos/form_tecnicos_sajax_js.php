...
?>
  ...
  function do_ajax_form_tecnicos_validate_nome_tecnico()
  {
    var nomeCampo_nome_tecnico = "nome_tecnico";
    var var_nome_tecnico = scAjaxGetFieldText(nomeCampo_nome_tecnico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tecnicos_validate_nome_tecnico(var_nome_tecnico, var_script_case_init, do_ajax_form_tecnicos_validate_nome_tecnico_cb);
  } // do_ajax_form_tecnicos_validate_nome_tecnico

  function do_ajax_form_tecnicos_validate_nome_tecnico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nome_tecnico";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tecnicos_validate_nome_tecnico_cb
  ...
  // ---------- Validate fone_tecnico
  function do_ajax_form_tecnicos_validate_fone_tecnico()
  {
    var nomeCampo_fone_tecnico = "fone_tecnico";
    var var_fone_tecnico = scAjaxGetFieldText(nomeCampo_fone_tecnico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tecnicos_validate_fone_tecnico(var_fone_tecnico, var_script_case_init, do_ajax_form_tecnicos_validate_fone_tecnico_cb);
  } // do_ajax_form_tecnicos_validate_fone_tecnico

  function do_ajax_form_tecnicos_validate_fone_tecnico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fone_tecnico";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tecnicos_validate_fone_tecnico_cb

  // ---------- Validate horario_tecnico
  function do_ajax_form_tecnicos_validate_horario_tecnico()
  {
    var nomeCampo_horario_tecnico = "horario_tecnico";
    var var_horario_tecnico = scAjaxGetFieldText(nomeCampo_horario_tecnico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tecnicos_validate_horario_tecnico(var_horario_tecnico, var_script_case_init, do_ajax_form_tecnicos_validate_horario_tecnico_cb);
  } // do_ajax_form_tecnicos_validate_horario_tecnico

  function do_ajax_form_tecnicos_validate_horario_tecnico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tecnicos_validate_horario_tecnico_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_tecnicos_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tecnicos_submit_form(var_nome_tecnico, var_email_tecnico, var_fone_tecnico, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tecnicos_submit_form_cb);
...
?>
  ...
  var scStatusDetail = {};
  scStatusDetail["form_horario_trabalho_tecnicos"] = "off";
  ...
  function perform_ajax_form_tecnicos_navigate_form()
  {
    ...
    scAjaxProcOn();
    scStatusDetail["form_horario_trabalho_tecnicos"] = "on";
...
?>
  function do_ajax_form_tecnicos_navigate_form_cb(sResp)
  {
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_horario_trabalho_tecnicos"] && "nmsc_iframe_liga_form_horario_trabalho_tecnicos" != scMasterDetailIframe["nmsc_iframe_liga_form_horario_trabalho_tecnicos"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_horario_trabalho_tecnicos"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_horario_trabalho_tecnicos').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_horario_trabalho_tecnicos').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_horario_trabalho_tecnicos').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
...
?>
  ...
  {
    if ("off" == scStatusDetail["form_horario_trabalho_tecnicos"])
    {
      return true;
    }
    return false;

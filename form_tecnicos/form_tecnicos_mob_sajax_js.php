...
?>
  ...
  function do_ajax_form_tecnicos_mob_validate_nome_tecnico()
  {
    ...
    x_ajax_form_tecnicos_mob_validate_nome_tecnico(var_nome_tecnico, var_script_case_init, do_ajax_form_tecnicos_mob_validate_nome_tecnico_cb);
  } // do_ajax_form_tecnicos_mob_validate_nome_tecnico

  function do_ajax_form_tecnicos_mob_validate_nome_tecnico_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tecnicos_mob_validate_nome_tecnico_cb
  ...
  function do_ajax_form_tecnicos_mob_validate_fone_tecnico()
  {
    var nomeCampo_fone_tecnico = "fone_tecnico";
    var var_fone_tecnico = scAjaxGetFieldText(nomeCampo_fone_tecnico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tecnicos_mob_validate_fone_tecnico(var_fone_tecnico, var_script_case_init, do_ajax_form_tecnicos_mob_validate_fone_tecnico_cb);
  } // do_ajax_form_tecnicos_mob_validate_fone_tecnico

  function do_ajax_form_tecnicos_mob_validate_fone_tecnico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
